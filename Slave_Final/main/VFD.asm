...
;	C:\Slave\Compiler\bin\opt2000.exe C:\Users\이진호\AppData\Local\Temp\TI84010 C:\Users\이진호\AppData\Local\Temp\TI8404 
;	C:\Slave\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\Slave\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\이진호\AppData\Local\Temp\TI8402 --template_info_file C:\Users\이진호\AppData\Local\Temp\TI8406 --object_file VFD.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdCtlRegInit"), DW_AT_symbol_name("_VfdCtlRegInit")
	...
	.dwattr DW$7, DW_AT_begin_line(0xa6)
...
;***************************************************************
_VfdCtlRegInit:
;*** 171	-----------------------    C$3 = &GpioDataRegs;
;*** 171	-----------------------    ((volatile unsigned *)C$3)[12] |= 1u;
;*** 172	-----------------------    *((volatile struct _GPADAT_BITS *)C$3+2L) |= 0x2000u;
;*** 173	-----------------------    *(&GpioDataRegs+2L) |= 0x1000u;
;*** 174	-----------------------    ((volatile unsigned *)C$3)[10] |= 1u;
;*** 175	-----------------------    *((volatile struct _GPADAT_BITS *)C$3+4L) |= 0x1000u;
...
DW$14	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	...
	.dwattr DW$14, DW_AT_location[DW_OP_reg16]
        MOVZ      AR7,AL                ; |167| 
	.dwpsn	"VFD.c",171,2
        MOVL      XAR5,#_GpioDataRegs   ; |171| 
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |171| 
        OR        *+XAR4[0],#0x0001     ; |171| 
	.dwpsn	"VFD.c",172,2
        OR        *+XAR5[2],#0x2000     ; |172| 
	.dwpsn	"VFD.c",173,2
        MOVW      DP,#_GpioDataRegs+2
        OR        @_GpioDataRegs+2,#0x1000 ; |173| 
	.dwpsn	"VFD.c",174,2
        MOVB      ACC,#10
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |174| 
...
;***	-----------------------g2:
;*** 180	-----------------------    C$2 = &GpioDataRegs;
;*** 180	-----------------------    ((volatile unsigned *)C$2)[12] |= 1u;
;*** 181	-----------------------    if ( CrlReg&1<<Cnt ) goto g4;
	.dwpsn	"VFD.c",180,3
        MOV       PH,#0
        MOV       PL,#12
        ADDUL     P,XAR5
...
;*** 187	-----------------------    *((volatile struct _GPADAT_BITS *)C$2+5L) |= 0x400u;
;*** 187	-----------------------    goto g5;
	.dwpsn	"VFD.c",187,4
        OR        *+XAR5[5],#0x0400     ; |187| 
        BF        L3,UNC                ; |187| 
        ; branch occurs ; |187| 
...
;***	-----------------------g4:
;*** 183	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
	.dwpsn	"VFD.c",183,4
        OR        @_GpioDataRegs+3,#0x0400 ; |183| 
DW$L$_VfdCtlRegInit$4$E:
L3:    
DW$L$_VfdCtlRegInit$5$B:
;***	-----------------------g5:
;*** 189	-----------------------    *(&GpioDataRegs+10L) |= 1u;
;*** 178	-----------------------    --Cnt;
;*** 178	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"VFD.c",189,3
        OR        @_GpioDataRegs+10,#0x0001 ; |189| 
	.dwpsn	"VFD.c",178,24
        ADDB      AL,#-1
	.dwpsn	"VFD.c",178,14
        BANZ      L1,AR6--              ; |178| 
...
;*** 192	-----------------------    ((volatile unsigned *)C$1)[2] |= 0x1000u;
;*** 193	-----------------------    *((volatile struct _GPBDAT_BITS *)C$1+12L) |= 1u;
;*** 193	-----------------------    return;
	.dwpsn	"VFD.c",192,2
        MOVL      XAR4,#_GpioDataRegs   ; |192| 
        OR        *+XAR4[2],#0x1000     ; |192| 
	.dwpsn	"VFD.c",193,2
        MOVB      ACC,#12
        ADDL      ACC,XAR4
        MOVL      XAR4,ACC              ; |193| 
...
DW$15	.dwtag  DW_TAG_loop
	.dwattr DW$15, DW_AT_name("C:\Slave\main\VFD.asm:L1:1:1533357030")
	.dwattr DW$15, DW_AT_begin_file("VFD.c")
	.dwattr DW$15, DW_AT_begin_line(0xb2)
	.dwattr DW$15, DW_AT_end_line(0xbe)
...
DW$19	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$7, DW_AT_end_line(0xc3)
...
DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdInit"), DW_AT_symbol_name("_VfdInit")
	...
	.dwattr DW$20, DW_AT_begin_line(0xc4)
...
;*** 198	-----------------------    ((volatile unsigned *)C$1)[4] |= 0x1000u;
;*** 199	-----------------------    *((volatile struct _GPBDAT_BITS *)C$1+12L) |= 1u;
;*** 200	-----------------------    ((volatile unsigned *)C$1)[5] |= 0x400u;
;*** 201	-----------------------    *(&GpioDataRegs+4L) |= 0x2000u;
;*** 202	-----------------------    VfdCtlRegInit(129u);
;*** 203	-----------------------    VfdCtlRegInit(77u);
;*** 203	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$21	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"VFD.c",198,2
        MOVL      XAR5,#_GpioDataRegs   ; |198| 
        OR        *+XAR5[4],#0x1000     ; |198| 
	.dwpsn	"VFD.c",199,2
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |199| 
	...
	.dwpsn	"VFD.c",200,2
        OR        *+XAR5[5],#0x0400     ; |200| 
	.dwpsn	"VFD.c",201,2
        MOVW      DP,#_GpioDataRegs+4
        OR        @_GpioDataRegs+4,#0x2000 ; |201| 
	.dwpsn	"VFD.c",202,2
        MOVB      AL,#129               ; |202| 
	...
	.dwpsn	"VFD.c",203,2
        MOVB      AL,#77                ; |203| 
        LCR       #_VfdCtlRegInit       ; |203| 
        ; call occurs [#_VfdCtlRegInit] ; |203| 
	.dwpsn	"VFD.c",204,1
        LRETR
        ; return occurs
	.dwattr DW$20, DW_AT_end_file("VFD.c")
	.dwattr DW$20, DW_AT_end_line(0xcc)
...
DW$22	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdDataLoad"), DW_AT_symbol_name("_VfdDataLoad")
	...
	.dwattr DW$22, DW_AT_begin_line(0xce)
...
;*** 216	-----------------------    ((volatile unsigned *)K$2)[12] |= 1u;
;*** 217	-----------------------    *((volatile struct _GPADAT_BITS *)K$2+4L) |= 0x2000u;
;*** 218	-----------------------    *((volatile struct _GPADAT_BITS *)K$2+2L) |= 0x1000u;
;*** 219	-----------------------    ((volatile unsigned *)K$2)[10] |= 1u;
;*** 220	-----------------------    *((volatile struct _GPADAT_BITS *)K$2+4L) |= 0x1000u;
;***  	-----------------------    #pragma MUST_ITERATE(8, 8, 8)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    K$26 = (char *)(&FontData);
;*** 212	-----------------------    ConverData = 0;
...
;* PL    assigned to U$28
DW$24	.dwtag  DW_TAG_variable, DW_AT_name("U$28"), DW_AT_symbol_name("U$28")
	.dwattr DW$24, DW_AT_type(*DW$T$5)
	.dwattr DW$24, DW_AT_location[DW_OP_reg2]
;* AR7   assigned to K$26
DW$25	.dwtag  DW_TAG_variable, DW_AT_name("K$26"), DW_AT_symbol_name("K$26")
...
DW$36	.dwtag  DW_TAG_variable, DW_AT_name("K$2"), DW_AT_symbol_name("K$2")
	...
	.dwattr DW$36, DW_AT_location[DW_OP_reg10]
        MOVL      XAR1,XAR4             ; |207| 
	.dwpsn	"VFD.c",216,2
        MOVL      XAR6,#_GpioDataRegs   ; |216| 
        MOVB      ACC,#12
        ADDL      ACC,XAR6
        MOVL      XAR5,ACC              ; |216| 
        OR        *+XAR5[0],#0x0001     ; |216| 
	.dwpsn	"VFD.c",217,2
        OR        *+XAR6[4],#0x2000     ; |217| 
	.dwpsn	"VFD.c",218,2
        OR        *+XAR6[2],#0x1000     ; |218| 
	.dwpsn	"VFD.c",219,2
        MOVB      ACC,#10
        ADDL      ACC,XAR6
        MOVL      XAR5,ACC              ; |219| 
        OR        *+XAR5[0],#0x0001     ; |219| 
	.dwpsn	"VFD.c",220,2
        OR        *+XAR6[4],#0x1000     ; |220| 
        MOVL      XAR7,#_FontData
	.dwpsn	"VFD.c",212,6
        SETC      SXM
        MOVB      XAR4,#7
        MOVB      XAR2,#0
        MOVL      XAR3,#_GpioDataRegs   ; |232| 
L4:    
...
;***	-----------------------g4:
;*** 228	-----------------------    ConverData |= (U$28>>y&1)<<6-y;
;*** 227	-----------------------    --y;
;*** 227	-----------------------    if ( (--L$3) != (-1) ) goto g4;
	.dwpsn	"VFD.c",228,5
        MOVB      XAR5,#6               ; |228| 
        MOV       T,AL                  ; |228| 
        SUB       AR5,AL                ; |228| 
...
;***	-----------------------g6:
;*** 232	-----------------------    K$2 = &GpioDataRegs;
;*** 232	-----------------------    ((volatile unsigned *)K$2)[12] |= 1u;
;*** 233	-----------------------    if ( ConverData&1<<x ) goto g8;
	.dwpsn	"VFD.c",232,5
        MOV       PH,#0
        MOV       PL,#12
        ADDUL     P,XAR3
        MOVL      XAR5,P                ; |232| 
        OR        *+XAR5[0],#0x0001     ; |232| 
	.dwpsn	"VFD.c",233,5
        MOVB      AH,#1                 ; |233| 
        MOV       T,AL                  ; |233| 
        LSL       AH,T                  ; |233| 
...
;*** 239	-----------------------    *((volatile struct _GPADAT_BITS *)K$2+5L) |= 0x400u;
;*** 239	-----------------------    goto g9;
	.dwpsn	"VFD.c",239,6
        OR        *+XAR3[5],#0x0400     ; |239| 
        BF        L9,UNC                ; |239| 
        ; branch occurs ; |239| 
...
;***	-----------------------g8:
;*** 235	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
	.dwpsn	"VFD.c",235,6
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0400 ; |235| 
DW$L$_VfdDataLoad$8$E:
L9:    
DW$L$_VfdDataLoad$9$B:
;***	-----------------------g9:
;*** 241	-----------------------    K$2 = &GpioDataRegs;
;*** 241	-----------------------    ((volatile unsigned *)K$2)[10] |= 1u;
;*** 230	-----------------------    --x;
;*** 230	-----------------------    if ( (--L$4) != (-1) ) goto g6;
	.dwpsn	"VFD.c",241,5
        MOV       PH,#0
        MOV       PL,#10
        ADDUL     P,XAR3
        MOVL      XAR5,P                ; |241| 
        OR        *+XAR5[0],#0x0001     ; |241| 
	.dwpsn	"VFD.c",230,23
        ADDB      AL,#-1
	.dwpsn	"VFD.c",230,15
        BANZ      L7,AR6--              ; |230| 
...
;*** 247	-----------------------    *((volatile struct _GPADAT_BITS *)K$2+2L) |= 0x1000u;
;*** 248	-----------------------    ((volatile unsigned *)K$2)[12] |= 1u;
;*** 248	-----------------------    return;
	.dwpsn	"VFD.c",247,2
        OR        *+XAR3[2],#0x1000     ; |247| 
	.dwpsn	"VFD.c",248,2
        MOVB      ACC,#12
        ADDL      ACC,XAR3
        MOVL      XAR4,ACC              ; |248| 
        OR        *+XAR4[0],#0x0001     ; |248| 
	.dwpsn	"VFD.c",250,1
	.dwcfa	0x1d, -8
        MOVL      XAR3,*--SP
	.dwcfa	0x1d, -6
...
DW$37	.dwtag  DW_TAG_loop
	.dwattr DW$37, DW_AT_name("C:\Slave\main\VFD.asm:L4:1:1533357030")
	.dwattr DW$37, DW_AT_begin_file("VFD.c")
	.dwattr DW$37, DW_AT_begin_line(0xdf)
	.dwattr DW$37, DW_AT_end_line(0xf6)
...
DW$40	.dwtag  DW_TAG_loop
	.dwattr DW$40, DW_AT_name("C:\Slave\main\VFD.asm:L5:2:1533357030")
	.dwattr DW$40, DW_AT_begin_file("VFD.c")
	.dwattr DW$40, DW_AT_begin_line(0xe1)
	.dwattr DW$40, DW_AT_end_line(0xf4)
...
DW$44	.dwtag  DW_TAG_loop
	.dwattr DW$44, DW_AT_name("C:\Slave\main\VFD.asm:L6:3:1533357030")
	.dwattr DW$44, DW_AT_begin_file("VFD.c")
	.dwattr DW$44, DW_AT_begin_line(0xe3)
	.dwattr DW$44, DW_AT_end_line(0xe4)
...
DW$46	.dwtag  DW_TAG_loop
	.dwattr DW$46, DW_AT_name("C:\Slave\main\VFD.asm:L7:3:1533357030")
	.dwattr DW$46, DW_AT_begin_file("VFD.c")
	.dwattr DW$46, DW_AT_begin_line(0xe6)
	.dwattr DW$46, DW_AT_end_line(0xf2)
...
DW$50	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$22, DW_AT_end_line(0xfa)
...
DW$51	.dwtag  DW_TAG_subprogram, DW_AT_name("VFDPrintf"), DW_AT_symbol_name("_VFDPrintf")
	...
	.dwattr DW$51, DW_AT_begin_line(0xfc)
...
_VFDPrintf:
;*** 257	-----------------------    C$1 = &Buff[0];
;*** 257	-----------------------    vsprintf(C$1, (char *)Form, (char *)(&Form));
;*** 259	-----------------------    VfdDataLoad(C$1);
;*** 259	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
...
DW$55	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"VFD.c",257,5
        ...
        MOVL      *-SP[2],XAR4          ; |257| 
        MOVL      XAR5,*-SP[8]          ; |257| 
        MOVL      XAR3,#_Buff$1$0       ; |257| 
        MOVL      XAR4,XAR3             ; |257| 
        LCR       #_vsprintf            ; |257| 
        ; call occurs [#_vsprintf] ; |257| 
	.dwpsn	"VFD.c",259,5
        MOVL      XAR4,XAR3             ; |259| 
        LCR       #_VfdDataLoad         ; |259| 
        ; call occurs [#_VfdDataLoad] ; |259| 
	.dwpsn	"VFD.c",260,1
        SUBB      SP,#2
	.dwcfa	0x1d, -4
        MOVL      XAR3,*--SP
