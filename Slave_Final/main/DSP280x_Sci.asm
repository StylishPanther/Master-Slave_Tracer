...
;* Date/Time created: Sat Aug 04 13:30:28 2018                 *
;***************************************************************
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\Slave\main\DSP280x_Sci.asm:L1:1:1533357028")
...
DW$16	.dwtag  DW_TAG_loop
	.dwattr DW$16, DW_AT_name("C:\Slave\main\DSP280x_Sci.asm:L2:1:1533357028")
...
DW$21	.dwtag  DW_TAG_loop
	.dwattr DW$21, DW_AT_name("C:\Slave\main\DSP280x_Sci.asm:L3:2:1533357028")
...
DW$23	.dwtag  DW_TAG_loop
	.dwattr DW$23, DW_AT_name("C:\Slave\main\DSP280x_Sci.asm:L5:2:1533357028")
...
DW$31	.dwtag  DW_TAG_loop
	.dwattr DW$31, DW_AT_name("C:\Slave\main\DSP280x_Sci.asm:L7:1:1533357028")
