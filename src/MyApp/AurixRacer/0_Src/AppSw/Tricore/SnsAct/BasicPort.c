...
/******************************************************************************/
void setOutputPin(Ifx_P *port, uint8 pin, boolean state)
{
    if (state)
    {
...
//	setOutputPin(LED2.port, LED2.pinIndex, IR_Port.led0);
	...
	//************************************************************************************************************************//
	//************************************************************************************************************************//
	IfxPort_setPinMode(YELLOW_LED.port, YELLOW_LED.pinIndex, IfxPort_Mode_outputPushPullGeneral);
	IfxPort_setPinPadDriver(YELLOW_LED.port, YELLOW_LED.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
	//	setOutputPin(YELLOW_LED.port, YELLOW_LED.pinIndex, ON);

		IfxPort_setPinMode(RED_LED.port, RED_LED.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(RED_LED.port, RED_LED.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
	//	setOutputPin(RED_LED.port, RED_LED.pinIndex, ON);


	    IfxPort_setPinMode(GREEN_LED.port, GREEN_LED.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(GREEN_LED.port, GREEN_LED.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
	//	setOutputPin(GREEN_LED.port, GREEN_LED.pinIndex, ON);


	    IfxPort_setPinMode(WHITE_LED.port, WHITE_LED.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(WHITE_LED.port, WHITE_LED.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
	//	setOutputPin(WHITE_LED.port, WHITE_LED.pinIndex, ON);

		 IfxPort_setPinMode(LED5.port, LED5.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		 IfxPort_setPinPadDriver(LED5.port, LED5.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
	...
	//************************************************************************************************************************//
	//************************************************************************************************************************//
		IfxPort_setPinModeInput(SW_UP_PORT.port, SW_UP_PORT.pinIndex, IfxPort_InputMode_noPullDevice);
		IfxPort_setPinModeInput(SW_DOWN_PORT.port, SW_DOWN_PORT.pinIndex, IfxPort_InputMode_noPullDevice);
		IfxPort_setPinModeInput(SW_RIGHT_PORT.port, SW_RIGHT_PORT.pinIndex, IfxPort_InputMode_noPullDevice);
		IfxPort_setPinModeInput(SW_LEFT_PORT.port, SW_LEFT_PORT.pinIndex, IfxPort_InputMode_noPullDevice);

		//
		IfxPort_setPinMode(VFD_DA.port, VFD_DA.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(VFD_DA.port, VFD_DA.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);


		IfxPort_setPinMode(VFD_RS.port, VFD_RS.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(VFD_RS.port, VFD_RS.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);

		IfxPort_setPinMode(VFD_CE.port, VFD_CE.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(VFD_CE.port, VFD_CE.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);


		IfxPort_setPinMode(VFD_CLK.port, VFD_CLK.pinIndex, IfxPort_Mode_outputPushPullGeneral);
		IfxPort_setPinPadDriver(VFD_CLK.port, VFD_CLK.pinIndex, IfxPort_PadDriver_cmosAutomotiveSpeed1);
...
//************************************************************************************************************************//
	...
	setOutputPin(M_INH_U.port, M_INH_U.pinIndex, FALSE);
	...
	IfxPort_setPinModeInput(ENCODER_DISTANCE.port,ENCODER_DISTANCE.pinIndex,IfxPort_InputMode_noPullDevice);
	IfxPort_setPinModeInput(ENCODER_DIRECTION.port,ENCODER_DIRECTION.pinIndex,IfxPort_InputMode_noPullDevice);
